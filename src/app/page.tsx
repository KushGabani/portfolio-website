...
export default async function Home() {
  return (
    <div className="relative flex flex-1 flex-col min-h-screen mb-12">
      <Navbar />
      <main className="overflow-hidden space-y-44">
        <section className="dashed-grid h-[93vh]">
          <div className="flex flex-col h-full">
            <div className="mx-auto w-full flex flex-1 flex-col justify-center max-w-6xl py-8 px-4 xl:px-0 space-y-6 sm:space-y-8">
              <div className="w-fit">
                <a href="https://keyflow.space" target="_blank">
              ...
              <h1 className="text-3xl font-bold tracking-tight md:text-4xl text-[#171717] lg:text-[4.75rem] md:leading-[1.15]">
                From algorithms to pixels, <br />I seek growth in every
                endeavor.
              </h1>
            ...
            <div className="w-full bg-white max-w-8xl py-4 border-b border-t">
              <MarqueeContainer />
            </div>
          </div>
        </section>
